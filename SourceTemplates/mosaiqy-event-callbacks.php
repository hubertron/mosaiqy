...
<body>
   ...
   <p style="text-align: center; margin: 30px 0;">
      Open a javascript console and reload the page. Some statements will appear when you open and close a zoom image.
   </p>   
...
<?php
    ...
    $(document).ready(function() {
        $('.mosaiqy').mosaiqy({
            ...
            /* you could use these events for GA tracking or something else */
               
            onOpenZoom      : function(thumbnail) {
               console.log('the zoom has been opened', thumbnail)
            },
            onCloseZoom     : function(thumbnail) {
               console.log('the zoom has been closed', thumbnail)
            },
